<div id="issue">
    <div id="call-input" class="issue-input">
        <select name="sort" id="sort" class="dropdown cat">
        ...
        <select name="sort" id="sort" class="dropdown priority">
            <option selected disabled value="">Priority</option>
            <option value="1">1</option>
            <option value="2">2</option>
            <option value="3">3</option>
        </select>
        <textarea rows="10" placeholder="Description" class="des"></textarea>
        <textarea rows="3" placeholder="Effected Software (item1, item2, ...)" class="soft"></textarea>
        <textarea rows="3" placeholder="Effected Hardware (item1, item2, ...)" class="hard"></textarea>
        <div class="issue-but">
            <input type="submit" class="cancel" value="Cancel" action="action" onclick="window.history.back(); return false;"/>
            <input type="submit" id="mytbn" class="next" value="Next"/>
        </div>
    </div>
</div>
<div id="query">
